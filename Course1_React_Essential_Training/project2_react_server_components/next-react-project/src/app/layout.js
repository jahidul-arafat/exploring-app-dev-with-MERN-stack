            ...
            <div className="container mx-auto px-4">
                <nav className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                        <Link href="/mountain">Mountain Route Info</Link>
                    </div>
                    <div className="flex items-center">
                        <Link href="/hotels">Hotels Route Info</Link>
                    </div>
                    <div className="flex items-center">
                        <Link href="/contact">Contact Route Info</Link>
                    </div>
                </nav>
            </div>
        </header>
...
// Parent Component
// will render all child component in every page of the routing
